...
ThreadCapturing::~ThreadCapturing(void){
	...
	delete data;
	data = nullptr;};
ThreadCapturing::ThreadCapturing(LPSTR windowName, VideoCapture captureDevice,int deviceNumber, DWORD dataThreadID, bool gazeTracking, bool openVideo) :
	Thread(), 
	...
	gazeTracking(gazeTracking)
{
	...
	//resizeWindow(_windowName,1024,800);
...
void ThreadCapturing::Run()
{
	...
	data->pupilPos.push_back(Point(0,0));
	if(gazeTracking)
		data->gazeTracking =true;
	else
		data->gazeTracking =false;
